    ...
    <div>
      <div className="flex h-screen justify-center items-center ">
        <form
          ...
          className="border border-info shadow-2xl px-12 py-12 rounded-xl space-y-4 w-96"
        >
          ...
          <div className="flex justify-between mx-2">
            <p>
              ...
              <Link
                to="/login"
                className="text-info underline cursor-pointer ml-16"
              >
                Login
              </Link>
            </p>
          ...
          <input
            type="submit"
            value="Signup"
            className="btn btn-outline btn-info text-lg mx-16 mb-4 px-10"
          />
        </form>
      </div>
    </div>
